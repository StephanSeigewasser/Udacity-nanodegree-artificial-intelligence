...
df = pd.read_csv('smsspamcollection/SMSSpamCollection', '\t', None, names=['label', 'sms_message'])
...
for i in documents:
    lower_case_documents.append(' '.join([word.lower() for word in i.split(" ")]))
...
Solution
'''
frequency_matrix = pd.DataFrame(doc_array, None, count_vector.get_feature_names())
frequency_matrix
